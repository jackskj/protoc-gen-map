...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:DUwLyMDMUauGMd9kSLIlhhYJNELm06HuxeBdkFkeax4=",
        version = "v0.0.0-20200407041343-bf15fae40dea",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:fnPsqIDRbCSgumaMCRpoIoF2s4qxv0xSSS0BVZUE/ss=",
        version = "v0.0.0-20191029031824-8986dd9e96cf",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:G4+YP9kaV4dJb79J5MobyApxX493Qa6VoiTceUmxqik=",
        version = "v0.4.0",
    )
    go_repository(
